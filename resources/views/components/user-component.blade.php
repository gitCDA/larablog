        ...
        <div class="px-8">
            ...
            <div class="flex flex-col max-w-sm px-6 py-4 mx-auto bg-white rounded-lg shadow-md">
                ...
                <li class="flex items-center -mx-4">
                    ...
                    <p><a href=" {{ route('posts.user',[ 'id' => $user->id ]) }} " 
                    class="mx-1 font-bold text-gray-700 hover:underline">{{ $user->name}}</a><span
                    class="text-sm font-light text-gray-700">Created </span></p>
                </li>
                @endforeach
            </div>
        </div>
